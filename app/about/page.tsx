              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10">
                {stats.map((s, i) => (
                  <FadeIn key={s.label} delay={i * 0.1} direction="up">
                    <div className="bg-orange-pale border border-orange-light rounded-xl p-4 text-center h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <FadeIn key={v.title} delay={i * 0.08} direction="up">
                <div className="bg-[#0f0d0b] border border-[#2a1f14] rounded-2xl p-8 hover:border-orange transition-all duration-300 group flex flex-col gap-4 h-full">
